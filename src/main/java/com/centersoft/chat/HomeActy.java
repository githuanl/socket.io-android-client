        ...
        socket.on(Socket.EVENT_CONNECT, new Emitter.Listener() {
            ...
            public void call(Object... args) {
                ...
                try {
                    ...
                    if (!msg.getFrom_user().equals(Constant.getLoginName())) {

                        EventBus.getDefault().post(new EventBusType(EBConstant.CHATMESSAGE, msg));

                        dao.saveMessage(msg);
                        LogUtils.json(JSON.toJSONString(dao.getAllMessageList()));
            ...
            public void call(Object... args) {
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(HomeActy.this, "连接关闭", Toast.LENGTH_SHORT).show();
                    }
                });
            }
