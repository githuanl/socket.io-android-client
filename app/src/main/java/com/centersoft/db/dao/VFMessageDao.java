...
public class VFMessageDao {
    ...
    public List<VFMessage> getMessageListWithToUser(String fromUser,String toUser,int offset,int limit){
        return DBManager.getInstance().getMessageListWithToUser(fromUser,toUser,offset,limit);
    }
