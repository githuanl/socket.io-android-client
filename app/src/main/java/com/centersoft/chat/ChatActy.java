...
public class ChatActy extends BaseActivity {
    ...
    public void sendMessage(Body_type type, String imageUrl) {
        try {
            ...
            message.setMsg_id("121212121212");
            message.setTimestamp((long) 111111);
            ChatApplication.getDaoInstant().getVFMessageDao().save(message);
            MyLog.i(Tag, "---------"+JSON.toJSONString(ChatApplication.getDaoInstant().getVFMessageDao().loadAll()));
