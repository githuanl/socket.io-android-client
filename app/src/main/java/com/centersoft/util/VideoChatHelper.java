        ...
        socket.on("_peers", new Emitter.Listener() {
            ...
            public void call(Object... args) {
                ...
                if (myId == null) {
                    ...
                    MyLog.i("myID 是空的，请检查");
                }

                if (factory == null) {

                    MyLog.i("注意下方this可能错误");
...
//                    MyLog.i("查看type是否正确answer：" + type);
//                    try {
//                        sdpa.put("type", typea);
//                        sdpa.put("sdp", remoteSdp.description);
//                        MyLog.i("可能错误description");
...
//                    } catch (JSONException e) {
//
//                        MyLog.i("错误：offer发送为空");
//                        e.printStackTrace();
//                    }

                    MyLog.i("createAnswer调用");
    ...
    * */
    ...
    private MediaConstraints peerConnectionConstraints() {
        ...
        MyLog.i("peerConnection约束是否要加东西????");
    ...
    private class Peer implements SdpObserver, PeerConnection.Observer{
        ...
        public void onIceCandidate(IceCandidate iceCandidate) {
            MyLog.i("-------onIceCandidate ==》IceCandidate");
            ...
            try {
                ...
                socket.emit("__ice_candidate", dataObject);
            } catch (JSONException e) {
                e.printStackTrace();
            }
        }
